	...
	<div class="row gx-4 gy-4">
		...
		<div class="col-12">
			<div class="row g-3">
					...
					<div class="col-6 col-sm-4 col-md-3 col-xl-2">
						<div class="card text-center shadow-sm border-0 h-100" style="background-color: <?= $bg ?>;" title="<?= $title ?>">
							<div class="card-body d-flex flex-column justify-content-center align-items-center" style="height: 100px;">
								<iconify-icon icon="<?= $icon ?>" width="40" height="40" aria-label="<?= $title ?>"></iconify-icon>
							</div>
							<div class="card-footer bg-white fw-semibold text-truncate">
								<a href="<?= $link ?>" class="text-decoration-none text-dark" target="_blank" rel="noopener noreferrer">
									<?= $title ?>
								</a>
							</div>
						</div>
				...
				<!-- More Projects Tile -->
				<div class="col-6 col-sm-4 col-md-3 col-xl-2">
					<div class="card text-center shadow-sm border border-dashed bg-light h-100" title="<?= t('projects.explore_more', [], 'Explore more') ?>">
						...
						<div class="card-footer bg-white text-muted small" data-i18n="dashboard.more_projects">
